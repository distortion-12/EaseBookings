...
const navigation = [
  ...
  { name: "JUL'Services", href: '/admin/services', icon: RectangleStackIcon },
      ...
      <div className="min-h-screen bg-gray-100">
                ...
                <Dialog.Panel className="relative mr-16 flex w-full max-w-xs flex-1">
                  ...
                  <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-600 px-6 pb-4">
                    <div className="flex h-16 shrink-0 items-center">
                      <span className="text-white text-xl font-bold">AppointEase</span>
                    </div>
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto bg-blue-700 px-6 pb-4">
            <div className="flex h-16 shrink-0 items-center">
              <span className="text-white text-2xl font-bold">AppointEase</span>
            </div>
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                <li>
        ...
        <div className="lg:pl-72">
          ...
          <main className="py-10">
            <div className="px-4 sm:px-6 lg:px-8">
              ...
              {/* This is where the specific page's content will go */}
              {children}
